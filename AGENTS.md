...
Before developing or changing any backend code, read `boas_praticas_backend.md` and apply it together with this `AGENTS.md`. The backend guide is the project playbook for Actions, controller boundaries, Form Requests, policies, persistence side effects, and keeping MVP code simple.
