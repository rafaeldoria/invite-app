    ...
    return (
        <AuthenticatedLayout>
            ...
            <main id="main-content" className="mx-auto w-full max-w-7xl px-5 py-8 sm:py-10">
                <EventForm mode="edit" submitUrl={event.links.update ?? ''} indexUrl={event.links.index ?? '/events'} event={event} timezoneOptions={timezoneOptions} defaultTimezone={event.timezone} t={t} />
            </main>
        </AuthenticatedLayout>
    );
}
